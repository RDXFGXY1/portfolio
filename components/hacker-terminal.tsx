...
export default function HackerTerminal() {
  ...
  const initialLines = [
    "$ whoami",
    "kyros - Discord Bot Developer - Born in Morocco (2004/5/27)",
    "$ age",
  ...
  const commands: Record<string, CommandType> = {
    ...
    whoami: {
      command: "whoami",
      output: "kyros - Discord Bot Developer - Born in Morocco (2004/5/27)",
    },
    bio: {
      command: "bio",
      output: [
        ...
        "BORN: May 27, 2004",
        "LOCATION: Morocco",
        "OCCUPATION: Discord Bot Developer",
      ...
      <div className="border border-white/20 bg-black/70 backdrop-blur-sm">
        ...
        <div className="flex items-center justify-between px-4 py-2 border-b border-white/10 bg-white/5">
          ...
          <div className="text-xs font-mono text-white/70">
            {showPuzzleGame ? "neural-puzzle-system ~ " : "kyros@terminal ~ "}
          </div>
